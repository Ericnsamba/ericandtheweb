    ...
    let animated = gsap.context(() => {
      gsap.utils.toArray(".cardCont").forEach( (card: any) => {
        ...
        const tl = gsap
          ...
          .to(front, { duration: .5, rotationX: 90, })
          .to(back, { duration: .5, rotationX: 0, z: 20  }, 0)
          // .to(card, { z: 50 }, 0)
          // .to(card, { z: 0 }, 0.5);
    ...
    <div className="flex w-full gap-5  min-h-screen">
      ...
      >
        <div className="flex flex-col w-full container  gap-y-20 lg:pb-10 p-5 ">
          ...
          {/* <div className="flex w-full flex-row  flex-wrap lg:flex-nowrap gap-5 lg:gap-0 lg:justify-between lg:w-9/12">
            <Link href="https://twitter.com/EricandTheWeb" target="_blank">
