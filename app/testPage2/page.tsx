    ...
    <div ref={component} className="cont">
      <div className="main">
          ...
          <div className="section">
            <div className="section-wrapper bg-stone-300o">
              <div className="content bg-pink-3000 z-10 mb-16">
                {/* <h1 className="hero-header header-1 lg:text-[10vh] text-[10vh]">
                  Hi, I'm Eric
                </h1> */}
              ...
              <div className="pin-wrapper ">
                <div
                  className="image-wrapper bg-slate-300 w-full"
                  id="heroImage"
                >
                  <Image
        ...
        <div className="section copy flex flex-col bg-white ">
          <div className="section-wrapper w-8/12 mx-auto">
            <div className="content space-y-[60px]">
              <p className="bio_copy copy_1">
                Eric Manasse is a skilled Production designer and Front-end
                developer, I bring a unique perspective to the table.
              </p>
              <p className="bio_copy copy_2">
                Proficient in technologies such as React.js, React Native,
                JavaScript, and Next.js, I am able to seamlessly bridge the gap
                between design and development.
              </p>
              <p className="bio_copy copy_3">
                I am passionate about creating visually stunning and
                user-friendly experiences that not only meet but exceed
                expectations.
              </p>
              <p className="bio_copy copy_4">
                Proficient in technologies such as React.js, React Native,
                JavaScript, and Next.js, I am able to seamlessly bridge the gap
                between design and development.{" "}
              </p>
              {/* <p>
                ...
                bring a unique perspective to the table. With my proficiency in
                technologies such as React.js, React Native, JavaScript, and
                Next.js, I am able to seamlessly bridge the gap between design
                and development. I am passionate about creating visually
                stunning and user-friendly experiences that not only meet but
                exceed expectations. I have had the pleasure of working on
                designs for some of the world's leading asset managers,
                including Generali, Boston Partners, Hermes, and CTI, during my
                time at Kurtosys. My experience and dedication to the industry
                make me a valuable asset to any team, and I am always excited
                for the opportunity to bring my skills to any company and create
                an impact.
              </p> */}
            </div>
          </div>
          ...
          <section
            className="experience__section marquee flex bg-teal-20 w-8/12 mx-auto pb-[10%] justify-start items-start overflow-hidden my-[60px]"
            id="vertical"
          >
            {/* Years of experience and Mentor */}
            <div className="flex justify-start items-center w-full h-full">
              <div className="flex flex-col justify-between gap-5 ">
                <div id="marquee1" className="marquee__inner flex first">
                  <h3
                    data-splitting
                    data-effect2
                ...
                <div id="marquee2" className="marquee__inner flex second">
                  <h3
                    data-splitting
                    data-effect2
                ...
                <div id="marquee3" className="marquee__inner flex first">
                  <h3
                    data-splitting
                    data-effect2
      ...
      <div className=" min-h-screen">{WorkExperience(experiences)}</div>
...
const WorkExperience = (experience: any) => {
  return (
    <div className="bg-lime-2000 mx-auto w-[794px] flex flex-col">
      {experience.map((proj: any, index: any) => {
        const year = proj.year;
        return (
          <div
            key={index.toString()}
            className="experience__main flex flex-col lg:flex-row justify-between lg:items-center items-start my-10 bg-emerald-1000 ">
            <div className="left__col year w-[285px]">
              <h3 className="year text-gray">{year ? year.substring(0, 4) : ""}</h3>
            </div>
            <div className="right__col flex flex_col w-[300px]">
              <p className="year text-black text-[34px]">{proj.company}</p>
              <p className="year text-gray text-sm uppercase">{proj.jobTitle}</p>
            </div>
          </div>
        );
      })}
