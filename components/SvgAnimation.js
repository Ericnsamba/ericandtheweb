...
export default function SvgAnimation(className) {
    ...
    useEffect(() => {
      document.addEventListener("mousemove", (e) => {
        ...
        //   "stroke-dashoffset:" + e.pageY + "px; stroke-dasharray: " + e.pageX,
          "fill:" + `linear-gradient(${xAxis}deg, rgba(${e.pageX},76,${e.pageY},1) 0%, rgba(9,9,${e.pageY},${yAxis}) 50%, rgba(${e.pageX},161,${e.pageY},${xAxis}) 100%)`
        );
      });
    }, []);
    return <div className={"svgAnimation hidden lg:flex"} ref={animationRef}>
         <svg width="958" height="92" viewBox="0 0 958 92" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g className="svg-elem-1 " fill="none" fill-rule="evenodd" stroke="#f2f2f2">
