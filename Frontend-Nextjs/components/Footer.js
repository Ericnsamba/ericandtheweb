          ...
          <div className="lg:flex">
            <div className="w-full lg:w-1/2 flex items-start justify-start ">
              <ul>
                <li className="py-8">
                  <Link
                    href="https://read.cv/join/eric_manasse"
                    className="text-sm font-bold text-body lg:text-sm leading-none text-forestGreen dark:text-green"
                  >
                    MY CV
                  </Link>
                </li>
            ...
            <div className="w-full lg:w-1/2 lg:mb-0 flex lg:justify-end justify-start items-center">
              <div className="flex items-center">
                ...
                <a
                  href="https://dribbble.com/ericandtheweb ease-in duration-300"
                  target="_blank"
                >
                  <div className="px-4 hover:animate-bounce ease-in duration-300">
                    <Dribbble
                      size={24}
                      className="ease-in duration-300 text-forestGreen dark:text-green cursor-pointer hover:text-green "
                    />
                  </div>
                </a>
              </div>
